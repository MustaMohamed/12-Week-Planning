		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class PlanEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public PlanEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<PlanEntity, UserEntity>("CreatedByUser", "CreatedPlans", (a, b) => a._createdByUser = b, a => a._createdByUser, (a, b) => a.CreatedByUser = b, WeeksPlanning.Entity.RelationClasses.StaticPlanRelations.UserEntityUsingCreatedByUserIdStatic, ()=>new PlanRelations().UserEntityUsingCreatedByUserId, null, new int[] { (int)PlanFieldIndex.CreatedByUserId }, null, true, (int)WeeksPlanning.Entity.EntityType.UserEntity);
				AddNavigatorMetaData<PlanEntity, UserEntity>("ModifiedByUser", "ModifiedPlans", (a, b) => a._modifiedByUser = b, a => a._modifiedByUser, (a, b) => a.ModifiedByUser = b, WeeksPlanning.Entity.RelationClasses.StaticPlanRelations.UserEntityUsingLastModifiedByUserIdStatic, ()=>new PlanRelations().UserEntityUsingLastModifiedByUserId, null, new int[] { (int)PlanFieldIndex.LastModifiedByUserId }, null, true, (int)WeeksPlanning.Entity.EntityType.UserEntity);
			}
		}
